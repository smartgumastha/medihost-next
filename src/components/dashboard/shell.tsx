...
const SECTIONS: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Brand studio', letter: 'B', href: '/dashboard/brand', badge: 'growth', iconBg: '#FEF3C7', iconColor: '#D97706' },
      { label: 'Ads manager', letter: 'D', href: '/dashboard/ads', badge: 'pro', iconBg: '#FEF3C7', iconColor: '#D97706' },
