  ...
  try {
    ...
    const signupRes = await fetch(`${API_BASE}/api/presence/partner-auth/signup`, {
      ...
      body: JSON.stringify({
        ...
        phone: body.phone || '',
        business_name: body.business_name || body.clinic_name || '',
    ...
    const user = {
      ...
      trial_ends_at: partnerData.trial_ends_at ? Number(partnerData.trial_ends_at) : undefined,
      subscription_status: String(partnerData.subscription_status || ''),
    };
