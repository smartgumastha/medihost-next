...
export async function POST(request: NextRequest) {
  try {
    ...
    var res = await hmsFetch(`${BACKEND}/api/hospitals/${auth.hospitalId}/bills/from-orders`, auth, {
    ...
    console.error("[POST /api/billing-desk/from-orders] Error:", err instanceof Error ? err.message : err);
